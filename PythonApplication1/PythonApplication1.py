...
class CharacterWidget(QWidget):
    ...
    def mouseMoveEvent(self, event):
        ...
        key = int((widgetPosition.y() / self.squareSize) * self.columns + widgetPosition.x() / self.squareSize)
    ...
    def mousePressEvent(self, event):
        if event.button() == QtCore.Qt.LeftButton:
            self.lastKey = int((event.y() / self.squareSize) * self.columns + event.x() / self.squareSize)
            c = chr(self.lastKey)
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        fontMergingLabel = QtWidgets.QLabel("Automatic Font Merging:")
        self.fontMerging = QtWidgets.QCheckBox()
        ...
        clipboardButton = QtWidgets.QPushButton("&To clipboard")
